...
const Policies = () => {
  ...
  const policies = {
    privacy: {
      ...
      content:
        "Chúng tôi cam kết bảo vệ thông tin cá nhân của bạn. Thông tin chi tiết về cách chúng tôi thu thập, sử dụng và bảo vệ dữ liệu của bạn.",
    },
    terms: {
    ...
    refund: {
      ...
      content:
        "Thông tin về quy trình hoàn trả và các điều kiện áp dụng cho các sản phẩm hoặc dịch vụ của chúng tôi.",
    },
    shipping: {
      title: "Chính sách vận chuyển",
      content:
        "Chi tiết về các phương thức vận chuyển, thời gian giao hàng và chi phí liên quan.",
    },
  };
