  ...
  const onFinish = async (values) => {
    try {
      ...
      const response = await api.post(
        `Compatibility/GetTheCompatibilityOfUserByListFish?ShapeID=${selectedPondShape}&Direction=${pondDirection}&DOB=${birthdate.format(
          "YYYY-MM-DD"
        )}&Gender=${Gender}`,
        payload
      );
