...
GO
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD004', N'Silver', CAST(N'2024-09-11' AS Date), CAST(N'2024-12-10' AS Date), 2, 4000000, CAST(N'2024-09-15T00:00:00.000' AS DateTime))
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD065', N'Silver', CAST(N'2024-10-30' AS Date), CAST(N'2024-11-29' AS Date), 3, 6000000, CAST(N'2024-10-30T17:43:02.000' AS DateTime))
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD081', N'Diamond', CAST(N'2024-10-30' AS Date), CAST(N'2025-03-29' AS Date), 5, 30000000, CAST(N'2024-10-30T00:00:00.000' AS DateTime))
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD083', N'Silver', CAST(N'2024-09-30' AS Date), CAST(N'2024-12-29' AS Date), 3, 6000000, CAST(N'2024-10-30T17:50:32.000' AS DateTime))
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD126', N'Gold', CAST(N'2024-10-11' AS Date), CAST(N'2024-12-10' AS Date), 2, 8000000, CAST(N'2024-10-15T00:00:00.000' AS DateTime))
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD189', N'Diamond', CAST(N'2024-10-15' AS Date), CAST(N'2024-12-14' AS Date), 2, 12000000, CAST(N'2024-10-15T00:00:00.000' AS DateTime))
...
INSERT [dbo].[Ads_Package] ([AdID], [Rank], [StartDate], [ExpiredDate], [Quantity], [Total], [CreateAt]) VALUES (N'AD419', N'Gold', CAST(N'2024-08-01' AS Date), CAST(N'2024-11-30' AS Date), 2, 8000000, CAST(N'2024-08-15T00:00:00.000' AS DateTime))
